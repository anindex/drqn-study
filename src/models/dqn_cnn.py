...
class DQNCNNModel(Model):
    def __init__(self, **kwargs):
        ...
        self.conv1 = nn.Conv2d(self.input_dims['state_shape'][0], self.kernel_num, kernel_size=7, stride=2)  # assuming grayscale
        self.conv2 = nn.Conv2d(self.kernel_num, self.kernel_num * 2, kernel_size=5, stride=2)
        self.conv3 = nn.Conv2d(self.kernel_num * 2, self.kernel_num * 2, kernel_size=3, stride=1)
        self.fc4 = nn.Linear(self.kernel_num * 2 * 16 * 16, self.hidden_dim)
